...
# O script também incluiu parâmetros específicos de simulação como detalhes de plantio, irrigação, controle de simulação e fertilização. Estes parâmetros foram 
# definidos para cada ponto de simulação utilizando dados locais e o arquivo X (denominada na tese de Arquivo Setup de CulturaP) do DSSAT foi atualizado com estas informações. 
